 ...
 *
 */
void MCAL_SPI_Send_Data(SPI_Typedef *SPIx, uint16_t *pTxBuffer, enum SPI_Polling_Mechanism Polling_En)
{
	// TODO Checker
 ...
 * Note 			- None
 */
void MCAL_SPI_Recieve_Data(SPI_Typedef *SPIx, uint16_t *pRxBuffer, enum SPI_Polling_Mechanism Polling_En)
{
	if(Polling_En == SPI_enable)
	{
 ...
 * Note 			- None
 */
void MCAL_SPI_TX_RX(SPI_Typedef *SPIx, uint16_t *pTxBuffer, enum SPI_Polling_Mechanism Polling_En)
{
	if(Polling_En == SPI_enable)
	{
		/* Wait for transmission complete */
